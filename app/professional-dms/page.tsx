      ...
      <div className="flex-1 min-w-0">
        <div className="flex items-center gap-1.5">
          ...
          <span className="text-[9px] font-bold uppercase tracking-wide px-1.5 py-0.5 rounded-full flex-shrink-0"
            style={{ background: role === "artist" ? "rgba(255,20,147,0.2)" : "rgba(255,255,255,0.08)", color: role === "artist" ? "#CC33AA" : "rgba(255,255,255,0.4)" }}>
    ...
    <div className="max-w-lg mx-auto pb-24">
      ...
      <div className="px-4 py-6">
        {threads.length === 0 ? (
          ...
          <div className="rounded-2xl overflow-hidden" style={{ background: "#0A0A0A", border: "1px solid #ffffff10" }}>
