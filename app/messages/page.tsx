  ...
  return (
    ...
    >
      <div
        ...
        style={{ background: "#111111", border: "1px solid #ffffff15" }}
      ...
      >
        ...
        <div className="px-4 pt-3 pb-2">
          <input
            ...
            className="w-full rounded-xl px-4 py-2.5 text-sm text-white placeholder-white/30 outline-none focus:ring-2 focus:ring-pink-500 transition"
          ...
          <div style={{ borderTop: "1px solid #ffffff10" }}>
            {convos.filter(c => !c.isBlocked).map(c => (
              <button
                ...
                style={{ borderBottom: "1px solid #ffffff08", background: c.isUnread ? "rgba(255,20,147,0.06)" : undefined }}
              >
                <div className="relative flex-shrink-0">
                  <Avatar src={c.other.image} name={c.other.name} username={c.other.username} size={48} />
                  {c.isUnread && (
                    <span className="absolute bottom-0 right-0 w-3 h-3 rounded-full border-2 border-[#000000]" style={{ background: "linear-gradient(135deg,#FF1493,#CC33AA)" }} />
                  )}
                </div>
                ...
                <div className="flex flex-col items-end gap-1.5 flex-shrink-0">
                  ...
                  {c.isUnread && (
                    <span className="w-2 h-2 rounded-full" style={{ background: "linear-gradient(135deg,#FF1493,#CC33AA)" }} />
                  )}
                </div>
              </button>
            ))}
